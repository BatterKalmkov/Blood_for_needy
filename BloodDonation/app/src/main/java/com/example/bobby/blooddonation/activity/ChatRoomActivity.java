...
import com.example.bobby.blooddonation.adapter.ChatRoomThreadAdapter;
import com.example.bobby.blooddonation.adapter.ChatRoomsAdapter;
...
public class ChatRoomActivity extends AppCompatActivity {
    ...
    private void handlePushNotification(Intent intent) {
        ...
        if (message != null && chatRoomId != null) {
            ...
            else
            {
                ...
                ChatRoomsAdapter mAdapter1 = new ChatRoomsAdapter(this, chatRoomArrayList);
    ...
    private void sendMessage() {
        ...
        Toast.makeText(ChatRoomActivity.this,MyApplication.getInstance().getPrefManager().getUser().getId()+message , Toast.LENGTH_SHORT).show();
