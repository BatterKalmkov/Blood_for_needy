...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyApplication.getInstance().getPrefManager().getUser() != null) {
            startActivity(new Intent(this, com.example.bobby.blooddonation.activity.MainActivity.class));
            finish();
        }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getBoolean("error") == false) {
                        ...
                        // start main activity
                        startActivity(new Intent(getApplicationContext(), com.example.bobby.blooddonation.activity.MainActivity.class));
                        finish();
