...
public class DatabaseHelper extends SQLiteOpenHelper {
    public static final String Database_Name="blooddonationsignin.db";
    public static final String Table_Name="blooddonationsignin_table";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create table blooddonationsignin_table(ID INTEGER PRIMARY KEY AUTOINCREMENT,username TEXT,password TEXT,logout Text)");
    }
