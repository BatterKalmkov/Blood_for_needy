...
public class needdonor extends AppCompatActivity  implements AdapterView.OnItemSelectedListener{
    Spinner spinner1,spinner2,spinner3;
    Button b1;
    public  static String item2,district2,bloodgroup2;
    AlertDialog b3;
    EditText e1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_needdonor);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(district2.equals("Select District-") ||item2.equals("Select State-") || bloodgroup2.equals("Select Blood Group-") )
                {
                    Toast.makeText(needdonor.this, "Please fill all the details", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    View v1 = getLayoutInflater().inflate(R.layout.broadcast, null);
                    AlertDialog.Builder b2 = new AlertDialog.Builder(needdonor.this)
                            .setCancelable(true)
                            .setView(v1);
                    ...
                    e1.setText("Urgent Blood("+bloodgroup2+") required- If interested in donating blood,please contact-"+ MyApplication.getInstance().getPrefManager().getUser().getName()+"\nEmail-"+MyApplication.getInstance().getPrefManager().getUser().getEmail()+"\nLocation-"+district2+", "+item2);
                    ...
                    Button b11 = (Button) v1.findViewById(R.id.button9);
                    b11.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            String endPoint = EndPoints.BROADCAST_MESSAGE;
                            StringRequest strReq = new StringRequest(Request.Method.POST,
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (obj.getBoolean("error") == false) {
                                            ...
                                            Intent intent=new Intent(needdonor.this,MainActivity.class);
                                            startActivity(intent);
                                            finish();

                                        } else {
                                            Toast.makeText(getApplicationContext(), "Unable to sent messages", Toast.LENGTH_LONG).show();
                                        }
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    ...
                                    e1.setText("Urgent Blood("+bloodgroup2+") required- If interested in donating blood,please contact-"+MyApplication.getInstance2().getPrefManager2().getUser2().getName()+"\nEmail-"+MyApplication.getInstance2().getPrefManager2().getUser2().getEmail()+"\nLocation-"+district2+", "+item2);
                                }
                            }) {
                                ...
                                protected Map<String, String> getParams() {
                                    ...
                                    params.put("district",district2);
                                    params.put("state",item2);
                                    params.put("bloodgroup",bloodgroup2);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if(parent.toString().contains("spinner11")) {
            ...
            if (item2.equals("Andhra Pradesh")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Arunachal Pradesh")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Chhattisgarh")) {
                List<String> categories2 = new ArrayList<String>();
                categories2.add(0,"Select district");
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Himachal Pradesh")) {
                List<String> categories2 = new ArrayList<String>();
                categories2.add("Bilaspur");
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Jammu and Kashmir")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Jharkhand")) {
                List<String> categories2 = new ArrayList<String>();
            ...
            else if (item2.equals("Karnataka"))
            {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Madhya Pradesh")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Maharashtra")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Meghalaya")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Rajasthan")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Tamil Nadu")) {
                List<String>
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Telangana")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Uttar Pradesh")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Uttarakhand")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("West Bengal")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Andaman and Nicobar Islands")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("New Delhi")) {
                List<String> categories2 = new ArrayList<String>();
                ...
                dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner2.setAdapter(dataAdapter2);
            } else if (item2.equals("Puducherry")) {
                List<String> categories2 = new ArrayList<String>();
            ...
            district2=parent.getItemAtPosition(position).toString();
        }
        else
        {
