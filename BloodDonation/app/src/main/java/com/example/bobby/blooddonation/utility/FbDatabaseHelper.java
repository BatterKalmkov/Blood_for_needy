...
public class FbDatabaseHelper extends SQLiteOpenHelper {
    public static final String Database_Name="blooddonationfbsignin.db";
    public static final String Table_Name="blooddonationfbsignin_table";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create table blooddonationfbsignin_table(ID INTEGER PRIMARY KEY AUTOINCREMENT,logout Text,fbid TEXT,fbname TEXT, fbpic TEXT, fbemail TEXT,fbgender TEXT)");
    }
