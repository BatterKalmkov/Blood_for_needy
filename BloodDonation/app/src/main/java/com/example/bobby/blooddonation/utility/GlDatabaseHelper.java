...
public class GlDatabaseHelper extends SQLiteOpenHelper {
    public static final String Database_Name="blooddonationglsignin.db";
    public static final String Table_Name="blooddonationglsignin_table";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create table blooddonationglsignin_table(ID INTEGER PRIMARY KEY AUTOINCREMENT,logout Text,googleid TEXT,googlename TEXT, googlepic TEXT, googleemail TEXT)");
    }
