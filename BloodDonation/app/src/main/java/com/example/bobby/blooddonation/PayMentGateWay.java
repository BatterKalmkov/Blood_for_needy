...
public class PayMentGateWay extends AppCompatActivity {
    ...
    //String base_url="https://secure.payu.";//
    int error=0;
    String hashString="";
    ...
    static String getFirstName, getNumber, getEmailAddress, getRechargeAmt,getCity,getState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCity      = oIntent.getExtras().getString("CITY");
        getState = oIntent.getExtras().getString("STATE");
        ...
        params.put("productinfo", "Blood Donation app");
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                public void run() {
                    ...
                    startActivity(intent);
                    finish();
                    Toast.makeText(getApplicationContext(), "Payment Successfull-Thank you for your contribution", Toast.LENGTH_LONG).show();
                }
            });
        }
        ...
        public void failure(final String id, String error) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent intent=new Intent(PayMentGateWay.this,gethappiness.class);
                    intent.putExtra("test",getFirstName);
                    startActivity(intent);
                    finish();
                }
        ...
        public void failure(final String params) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent intent=new Intent(PayMentGateWay.this,payumoneyintegration.class);
                    intent.putExtra("test",getFirstName);
                    startActivity(intent);
                    finish();
                }
