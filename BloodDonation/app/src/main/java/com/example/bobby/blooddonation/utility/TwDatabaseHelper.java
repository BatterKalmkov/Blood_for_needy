...
public class TwDatabaseHelper extends SQLiteOpenHelper {
    public static final String Database_Name="blooddonationtwsignin.db";
    public static final String Table_Name="blooddonationtwsignin_table";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create table blooddonationtwsignin_table(ID INTEGER PRIMARY KEY AUTOINCREMENT,logout Text,twid Text, twname TEXT,twpic TEXT)");
    }
    ...
    public boolean insertdata(String logout,String twid,String twname,String twpic)
    {
