...
public class LoginActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyApplication.getInstance2().getPrefManager2().getUser2() != null) {
            startActivity(new Intent(this, com.example.bobby.blooddonation.activity.availabledonors.class));
            finish();
        }
    ...
    private void login() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                EndPoints.LOGIN2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getBoolean("error") == false) {
                        ...
                        User2 user = new User2(userObj.getString("user_id"),
                                userObj.getString("name"),
                                userObj.getString("email"));

                        // storing user in shared preferences
                        MyApplication.getInstance2().getPrefManager2().storeUser2(user);

                        // start main activity
                        startActivity(new Intent(getApplicationContext(), com.example.bobby.blooddonation.activity.availabledonors.class));
                        finish();
