...
public class Signup extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner spinner2,spinner3,spinner;
    ImageButton ib;
    EditText e2,e3,e4,e5;
    Button b1;
    String bloodgroup,username, email,mobile,password,item,district;
    ...
    {
        Toast.makeText(Signup.this, "select", Toast.LENGTH_SHORT).show();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               password= e5.getText().toString();
                ...
                if(district.equals("Select district") ||item.equals("Select state") || bloodgroup.equals("Select Blood Group") || e2.getText().toString().isEmpty() || e3.getText().toString().isEmpty() || e4.getText().toString().isEmpty() || e5.getText().toString().isEmpty())
                {
    ...
    class JSONP extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            jsonurl ="http://sixthsenseit.com/blood/signup.php";
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                String postdata = URLEncoder.encode("username") + "=" + URLEncoder.encode(username) + "&" + URLEncoder.encode("password") + "=" + URLEncoder.encode(password)
                        ...
                        + "&" + URLEncoder.encode("pic") + "=" + URLEncoder.encode(encodedImage)+ "&" + URLEncoder.encode("bloodgroup") + "=" + URLEncoder.encode(bloodgroup)
                        + "&" + URLEncoder.encode("district") + "=" + URLEncoder.encode(district)+ "&" + URLEncoder.encode("state") + "=" + URLEncoder.encode(item);
